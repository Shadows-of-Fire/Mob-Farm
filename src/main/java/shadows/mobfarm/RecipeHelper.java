...
public class RecipeHelper {
	...
	public static void addOldShaped(ItemStack output, Object... input) {
		addRecipe(j++, new ShapedFakeRecipe(new ResourceLocation(MobFarm.MODID, "recipes" + j), output, input));
	}
	...
	public static ShapedRecipes genShaped(ItemStack output, int l, int w, Object[] input) {
		if (l * w != input.length)
			throw new UnsupportedOperationException(
					"Attempted to add invalid shaped recipe.  Complain to the author of  " + MobFarm.MODNAME);
	...
	public static NonNullList<Ingredient> createInput(Object[] input) {
		...
		for (int i = 0; i < input.length; i++) {
			...
			if (k instanceof String) {
				...
				throw new UnsupportedOperationException(
						"Attempted to add invalid shapeless recipe.  Complain to the author of  " + MobFarm.MODNAME);
			}
		}
		return inputL;
	}

	public static class ShapedFakeRecipe implements IRecipe {
		...
		public ShapedFakeRecipe(ResourceLocation group, Block result, Object... recipe) {
			this(group, new ItemStack(result), recipe);
		}

		public ShapedFakeRecipe(ResourceLocation group, Item result, Object... recipe) {
			this(group, new ItemStack(result), recipe);
		}

		public ShapedFakeRecipe(ResourceLocation group, @Nonnull ItemStack result, Object... recipe) {
			this.group = group;
			output = result.copy();
		...
		public ShapedFakeRecipe setMirrored(boolean mirror) {
			mirrored = mirror;
			return this;
		}
